                          ...
                          {type === AdoptionRequestType.RECEIVED && (
                            <div className="flex flex-row items-center mt-8 lg:mt-0">
                              ...
                              <div className="ml-4">
                                ...
                                <p>
                                  Telefone: {adoptionRequest.intender.phone}
                                </p>
                ...
                emptyComponent={() => (
                  <div className="border rounded-lg m-5 p-5 flex flex-col justify-center items-center bg-white ">
                    ...
                    <p className="mt-5 text-gray-900 text-sm">
                      A busca não retornou nenhum resultado. Se você acha que
                      isto pode ser um erro de sistema, por favor, contate o
                      suporte.
                    </p>
                  </div>
                )}
