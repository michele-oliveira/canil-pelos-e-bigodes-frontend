        ...
        <div className="relative bg-gray-800 m-10 p-6 rounded-lg flex flex-col md:flex-row items-center overflow-hidden">
          <div className="relative z-10 flex flex-col justify-center flex-grow md:mr-6 mb-6 md:mb-0">
            ...
            >
              ...
              transformar vidas – tanto dos cães e gatos quanto das pessoas que
              os adotam.
            </p>
            <p
              className="text-lg md:text-2xl text-gray-50 mb-6 text-center md:text-left"
            ...
            >
              ...
              cheios de carinho e cuidado para nossos amigos de quatro patas.
              Cada cachorro e gato registrados tem uma história única, e cada
              adoção marca o começo de um novo capítulo cheio de esperança.
            </p>
            <p
              className="text-lg md:text-2xl text-gray-50 mb-6 text-center md:text-left"
              style={{ fontFamily: "Raleway, serif" }}
            ...
            >
              ...
              conosco, você não leva apenas um cachorro ou gato para casa, mas
              sim um novo membro da família, um amigo leal para a vida.
            </p>
            <p
              className="text-lg md:text-2xl text-gray-50 mb-6 text-center md:text-left"
              style={{ fontFamily: "Raleway, serif" }}
